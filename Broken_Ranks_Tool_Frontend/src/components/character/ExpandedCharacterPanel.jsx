...
const ExpandedCharacterPanel = ({ development }) => (
    <div className="bg-gradient-to-b from-stone-900 to-black p-6 border-2 border-stone-800 shadow-[0_0_30px_rgba(0,0,0,0.9)] flex flex-col shrink-0 h-full w-full">
        ...
        <div className="mb-6 p-3 bg-stone-950 border border-stone-800 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)] flex justify-between items-center relative overflow-hidden">
            ...
            <span
                className={`text-xl font-bold font-serif relative z-10 transition-colors ${development.pointsLeft > 0 ? "text-amber-600 drop-shadow-[0_0_5px_rgba(217,119,6,0.5)]" : "text-stone-600"}`}
            >
                {development.pointsLeft} / {development.totalPoints}
            </span>
        </div>
                ...
                >
                    <div className="flex flex-col">
                        ...
                        <span className="text-2xl font-bold font-serif text-stone-200 group-hover:text-amber-500 transition-colors">
                            {development.finalStats[name]}
                        </span>
                    </div>
                    <div className="flex items-center gap-3">
                        {development.spentPoints[name] > 0 && (
                            <span className="text-[10px] text-amber-700 font-serif font-bold bg-stone-950 border border-amber-900/30 px-2 py-1 shadow-[inset_0_0_10px_rgba(0,0,0,1)]">
                                +{development.spentPoints[name]} pkt
                            </span>
                        )}
...
export default ExpandedCharacterPanel;
