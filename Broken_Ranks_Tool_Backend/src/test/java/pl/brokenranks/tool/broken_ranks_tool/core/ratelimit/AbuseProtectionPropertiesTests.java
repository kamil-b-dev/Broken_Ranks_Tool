...
class AbuseProtectionPropertiesTests {
    ...
    void acceptsPositiveConsistentLimits() {
        assertThatCode(() -> new AbuseProtectionProperties(1024, VALID_LIMIT, VALID_LIMIT))
                .doesNotThrowAnyException();
    }

    @Test
    void rejectsMissingOrNonPositiveConfiguration() {
        assertThatThrownBy(() -> new AbuseProtectionProperties(0, VALID_LIMIT, VALID_LIMIT))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new AbuseProtectionProperties(1024, null, VALID_LIMIT))
                .isInstanceOf(IllegalArgumentException.class);
