...
class OptimizationVariantGeneratorTests {
    ...
    void selectsImprovementWithinConfiguredLossAndRejectsLargerLoss() {
        ...
        List<GeneratedOptimizationVariant> strictVariants =
    ...
    private Fixture fixture(int maxLossPercent) {
        ...
        OptimizationContext context =
                new OptimizationContext(
                        ...
                        List.of(magicSlot, defenseSlot),
                        Map.of(0.0, List.of(magicSlot, defenseSlot)),
    ...
    private record Fixture(
            OptimizationVariantGenerator generator,
            OptimizationContext context,
            BuildState main,
            BuildState acceptable) {
