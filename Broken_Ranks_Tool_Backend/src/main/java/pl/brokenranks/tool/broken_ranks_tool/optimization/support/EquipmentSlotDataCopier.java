package pl.brokenranks.tool.broken_ranks_tool.optimization.support;
...
public class EquipmentSlotDataCopier {
    ...
    public static EquipmentRequest.SlotData copySlot(EquipmentRequest.SlotData source) {
        ...
        copy.setOrbLevels(
                source.getOrbLevels() != null ? new ArrayList<>(source.getOrbLevels()) : null);
        copy.setDrifIds(source.getDrifIds() != null ? new ArrayList<>(source.getDrifIds()) : null);
        copy.setDrifLevels(
                source.getDrifLevels() != null ? new HashMap<>(source.getDrifLevels()) : null);
        return copy;
    }
}
