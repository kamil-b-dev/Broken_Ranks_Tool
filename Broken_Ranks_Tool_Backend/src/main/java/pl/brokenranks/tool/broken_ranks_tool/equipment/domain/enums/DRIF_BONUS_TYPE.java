...
public enum DRIF_BONUS_TYPE {
    ...
    CRITICAL_DAMAGE_CHANCE_REDUCTION("Odpornosc kryt", 4, DRIF_CATEGORY.DEFENSIVE,60),
    ...
    // Ofensywne
    CRITICAL_CHANCE("Szansa kryt", 4, DRIF_CATEGORY.OFENSIVE,60),
    DAMAGE_ENERGY("Obrazenia energia", 3, DRIF_CATEGORY.OFENSIVE,null),
    DAMAGE_FIRE("Obrazenia ogien", 3, DRIF_CATEGORY.OFENSIVE,null),
    DAMAGE_FROST("Obrazenia zimno", 3, DRIF_CATEGORY.OFENSIVE,null),
    DAMAGE_MAGIC("Obrazenia magiczne", 3, DRIF_CATEGORY.OFENSIVE,null),
    DAMAGE_PHYSICAL("Obrazenia fizyczne", 3, DRIF_CATEGORY.OFENSIVE,null),
    DOUBLE_ATTACK_CHANCE("Podwojny atak", 4, DRIF_CATEGORY.OFENSIVE,60),
    DOUBLE_HIT_ROLL_CHANCE("Podwojne losowanie trafienia", 2, DRIF_CATEGORY.OFENSIVE,60),
    HIT_CHANCE_MELEE("Mod trafienia wrecz", 3, DRIF_CATEGORY.OFENSIVE,null),
    HIT_CHANCE_MENTAL("Mod trafienia mentalnego", 3, DRIF_CATEGORY.OFENSIVE,null),
    HIT_CHANCE_RANGED("Mod trafienia dystansowego", 3, DRIF_CATEGORY.OFENSIVE,null),
    MENTAL_DEFENSE_REDUCTION("Przelamanie odpornosci uroki", 2, DRIF_CATEGORY.OFENSIVE,60),
